...
- Alexander et al.'s maximised the probability and untargetted node adopted a treatment (innovation)
- It's not only about the neighbours initially targeted, the connection between neighbours (triangles) is also important to diffusion
