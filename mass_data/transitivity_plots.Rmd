...
g = dataCleaned %>% 
  ...
  ggplot(aes(x = Triangle/totalTriangles, y = difference, colour = Seeding, label = paste0(network, num_nodes))) +
  geom_point() + 
  theme_classic() +
  ggthemes::scale_colour_tableau()  +
  ...
  labs(colour = "Seeding Method Performing Better")
...
nodeProperties %>% 
  ...
  ggthemes::scale_colour_tableau() +
  labs(colour = "Seeding Method Performing Better") + 
  ggtitle("Comparison of Degree vs Triangles across Pair and Friend Dominating Sees")
